...
#BSP: modify logo-size XLBBBHLWJ-6 by baofu.zhang 20201029 start
BOOT_LOGO = hdplus1640
#BSP: modify logo-size XLBBBHLWJ-6 by baofu.zhang 20201029 end
BUILD_AGO_GMS = no
BUILD_KERNEL = yes
BUILD_LK = yes
BUILD_MD32 = no
BUILD_PRELOADER = yes
#BSP: add project macro by wanghanfeng 20201016 start
CUSTOM_BUILD_VERNO = CY-X688B-H659-A
#BSP: add project macro by wanghanfeng 20201016 start
...
#ITD: Modify Camera BringUp By ISP Team Start
CUSTOM_HAL_FLASHLIGHT = constant_flashlight
MTK_CAM_MAX_NUMBER_OF_CAMERA = 3
CUSTOM_HAL_IMGSENSOR = s5k3l6_mipi_raw s5k3l6ext2_mipi_raw ov13b10_mipi_raw ov8856ff_mipi_raw gc803430fps_mipi_raw gc08a3_mipi_raw gc6153_serial_yuv pblcs5k3l6_mipi_raw pblcs5k3l6ext2_mipi_raw pblcov13b10_mipi_raw pblcov8856ff_mipi_raw pblcgc803430fps_mipi_raw pblcgc08a3_mipi_raw pblcgc6153_serial_yuv
CUSTOM_HAL_MAIN2_IMGSENSOR = gc6153_serial_yuv
CUSTOM_HAL_MAIN_IMGSENSOR = s5k3l6_mipi_raw s5k3l6ext2_mipi_raw ov13b10_mipi_raw
TRAN_CAMERA_FAKE_STEREO_YUV_INDEX = 2
#ITD: Modify Camera BringUp By ISP Team End
#BSP: add XLBBCHLYYB-4 by zhi.chen for 20201028 start
#CUSTOM_HAL_MSENSORLIB = akl akm
#BSP: add XLBBCHLYYB-4 by zhi.chen for 20201028 end
CUSTOM_HAL_SENSORS = sensor
#ITD: Modify Camera BringUp By ISP Team Start
CUSTOM_HAL_SUB_IMGSENSOR = ov8856ff_mipi_raw gc803430fps_mipi_raw gc08a3_mipi_raw
#ITD: Modify Camera BringUp By ISP Team End
...
#BSP: add XLBBCHLYYB-4 by zhi.chen for 20201028 start
CUSTOM_HAL_MSENSORLIB = mmc5603_x688b
...
#BSP: add XLBBCHLYYB-4 by zhi.chen for 20201029 start
CUSTOM_KERNEL_DEVICE_ORIENTATION = no
#BSP: add XLBBCHLYYB-4 by zhi.chen for 20201029 end
...
#BSP: add XLBBCHLYYB-4 by zhi.chen for 20201028 end
#ITD: Modify Camera BringUp By ISP Team Start
CUSTOM_KERNEL_IMGSENSOR = s5k3l6_mipi_raw s5k3l6ext2_mipi_raw ov13b10_mipi_raw ov8856ff_mipi_raw gc803430fps_mipi_raw gc08a3_mipi_raw gc6153_serial_yuv
#ITD: Modify Camera BringUp By ISP Team End
...
CUSTOM_KERNEL_MAIN_IMGSENSOR = s5k3l6_mipi_raw s5k3l6ext2_mipi_raw ov13b10_mipi_raw
#ITD: Modify Camera BringUp By ISP Team End
CUSTOM_KERNEL_MOTION_DETECT =yes
#BSP: add XLBBCHLYYB-4 by zhi.chen for 20201030 start
...
#BSP: add XLBBCHLYYB-4 by zhi.chen for 20201030 end
#ITD: Modify Camera BringUp By ISP Team Start
CUSTOM_KERNEL_SUB_IMGSENSOR = ov8856ff_mipi_raw gc803430fps_mipi_raw gc08a3_mipi_raw
#ITD: Modify Camera BringUp By ISP Team End
...
#TSD: modify XLBBCHLYYB-1  by chengjinpeng 2020-10-21 start
CUSTOM_MODEM = x688b_h659_a1
#TSD: modify XLBBCHLYYB-1  by chengjinpeng 2020-10-21 end
...
#BSP:modify audio bring up XLBBCHLYYB-294 xinyu.zhao 20201027 start
MTK_AUDIO_NUMBER_OF_MIC = 1
MTK_AUDIO_NUMBER_OF_SPEAKER = 1
MTK_AUDIO_SPEAKER_PATH = int_hp_buf
#BSP:modify audio bring up XLBBCHLYYB-294 xinyu.zhao 20201027 end
...
#ITD:off MTK HDR for x688b by sijia.feng 20201105 begin
MTK_CAM_HDR_SUPPORT = no
#ITD:off MTK HDR for x688b by sijia.feng 20201105 end
...
#ITD:off MTK HDR for kf6 by sijia.feng 20201105 end
...
#TSD: modify XLBBCHLYYB-1 chengjinpeng 20201021 start
MTK_EXTERNAL_SIM_ONLY_SLOTS = 4
MTK_EXTERNAL_SIM_SUPPORT = yes
MTK_EXTERNAL_SIM_RSIM_ENHANCEMENT = yes
#TSD: modify XLBBCHLYYB-1 chengjinpeng 20201021 end
...
MTK_FM_SUPPORT = yes
#TSD: add TSDT-209 by zhouxiang.cao 20201103 start
MTK_FM_GPIO_FUNC = yes
#TSD: add TSDT-209 by zhouxiang.cao 20201103 end
...
#TSD: modify XLBBCHLYYB-1  by chengjinpeng 20201023 start
MTK_DYNAMIC_CCB_BUFFER_GEAR_ID =
#TSD: modify XLBBCHLYYB-1  by chengjinpeng 20201023 end
...
MTK_IRTX_SUPPORT = no
#BSP:modify for P1 debug XLBEPUB-6 by fan.hong 20200629 start
MTK_JEITA_STANDARD_SUPPORT = yes
#BSP:modify for P1 debug XLBEPUB-6 by fan.hong 20200629 end
MTK_K64_SUPPORT=yes
...
#TSD: modify XLBBCHLYYB-1  by chengjinpeng 20201021 start
MTK_MD1_SUPPORT = 9
#TSD: modify XLBBCHLYYB-1  by chengjinpeng 20201021 start
MTK_MD3_SUPPORT = 0
...
#SDD: modify jiangping.guo for XLBBBHLWJ-9 2020.11.04 start
MTK_DURASPEED_DEFAULT_ON = no
#SDD: modify jiangping.guo for XLBBBHLWJ-9 2020.11.04 end
MTK_MCF_SUPPORT = no
...
#BSP: add project clone format by wanghanfeng 20201016 start
...
#BSP: add project clone format by wanghanfeng 20201016 end
#SDD: add project sw version by jiangping.guo 20201016 start
MTK_BUILD_VERNO=X688B-H659ABCEFGHI-Q-GL-211110V386
TRAN_FINGERPRINT_BUILD_VERNO=211110V386
#SDD: add project sw version by jiangping.guo 20201016 end
#BSP: add project macro by wanghanfeng 20201016 start
CUSTOM_TRAN_PROJECT=tran_x688b
CUSTOM_TRAN_BOM=tran_x688b_a1
#BSP: add project macro by wanghanfeng 20201016 end
